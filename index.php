  ...
  <body>
    ...
    <header class="l-header" id="header">
      <nav class="nav bd-container">
        <a href="#" class="nav__logo"><em>Epu-Restaurant</em></a>
        ...
        <div class="nav__menu" id="nav-menu">
          <ul class="nav__list">
            ...
            <li class="nav__item">
              <a href="#about" class="nav__link">Nhà hàng</a>
            </li>
            <li class="nav__item">
              <a href="#services" class="nav__link">Dịch vụ</a>
            </li>
            <li class="nav__item">
              <a href="#category" class="nav__link">Loại thực đơn</a>
            </li>
            <li class="nav__item">
            ...
            ?>
                ...
                <a href="#" class="nav__link"
                  ><?php echo $_SESSION['username'] ?><a href="login.php"><i style="color:red; margin-left:10px"class='bx bx-log-out'></i></a></a>
              </li>
            <?php
              }
              else{
    ...
    <main class="l-main">
      ...
      <?php
        ...
        <div class="home__container bd-container bd-grid">
          <div class="home__data">
            <h1 class="home__title"><?php echo $row_banner['name_banner'] ?></h1>
          ...
          <img src="assets/img/<?php echo $row_banner['img_banner'] ?>" alt="" class="home__img" />
        </div>
        <?php
          }
        ?>
      ...
      <?php
        ...
        <div class="about__container bd-grid">
          <div class="about__data">
            <span class="section-subtitle about__initial">Nhà hàng</span>
            <h2 class="section-title about__initial"> <?php echo $row_shop['name_shop'] ?><br /></h2>
            <p class="about__description">
            <?php echo $row_shop['description_shop'] ?>
            </p>
            <a href="#" class="button">Xem thêm</a>
          </div>

          <img src="assets/img/<?php echo $row_shop['img_shop'] ?>" alt="" class="about__img" />
        </div>
        <?php
          }
        ?>
      ...
      <section class="services section bd-container" id="services">
        ...
        <div class="services__container bd-grid">
          <div class="services__content">
            ...
            <h3 class="services__title">Món ăn chất lượng</h3>
            <p class="services__description">
              Chúng tôi luôn cam kết về chất lượng sản phẩm và dịch vụ để đem
              đến cho bạn cảm giác thật ngon miệng trong mỗi bữa ăn của bạn
            </p>
          </div>
          ...
          <div class="services__content">
            ...
            <h3 class="services__title">Thực phẩm tươi</h3>
            <p class="services__description">
              Chúng tôi kết hợp cùng với các đối tác của nhà hàng, để đem những
              thực phẩm tươi sống vào món ăn của quý khách
            </p>
          </div>
          ...
          <div class="services__content">
            ...
            <h3 class="services__title">Giao hàng</h3>
            <p class="services__description">
              Trải nhiệm món ăn của chúng tôi, hoàn toàn được miễn phí giao hàng
              trong bán kính 5km, đặc biệt giao hàng trong 1 giờ !
            </p>
          </div>
        </div>
      </section>
      ...
      <!--========== Category ==========-->
      <section class="menu section bd-container" id="category">
        <span class="section-subtitle">Epu-Restaurant</span>
        <h2 class="section-title">Loại Thực Đơn</h2>
        ...
        <?php
          ...
          <div class="menu__content">
            <img src="assets/img/<?php echo $row_category['img_category'] ?>" alt="" class="menu__img" />
            <h3 style="display: flex; justify-content:center; align-items : center" class="menu__name"><?php echo $row_category['title_category'] ?></h3>
            <a href="product.php?id=<?php echo $row_category['id_category'] ?>" class="button menu__button"
      ...
      <section class="menu section bd-container" id="menu">
        ...
        <div class="menu__container bd-grid">
          <?php
            $sql_product = mysqli_query($conn,"SELECT * FROM tbl_products Where category_product = '$id_category' Order By id_product DESC LIMIT 3");
        ...
        <a class="detail" href="product.php?id=<?php echo $row_category['id_category'] ?>">Xem thêm</a>
        <?php
          }
        ?>
      </section>
        ...
        <div class="contact__container bd-grid">
          <div class="contact__data">
            <span class="section-subtitle contact__initial"
              ><?php echo $row_shop['name_shop'] ?></span
            >
            <h2 class="section-title contact__initial">Thông tin liên lạc</h2>
            <p class="contact__description">Địa chỉ : 
            <?php echo $row_shop['address_shop'] ?>
            </p>
            <p class="contact__description">Email :  <?php echo $row_shop['email_shop'] ?></p>
            <p class="contact__description">SĐT :  <?php echo $row_shop['phone_shop'] ?></p>
          </div>

          <div class="contact__button">
            <a href="#" class="button">Liên lạc ngay</a>
          </div>
        </div>
        <?php
          }
